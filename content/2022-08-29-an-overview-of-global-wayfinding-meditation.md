...
However, part of my critique also has to do with more specific things, such as the  style of the prose, which is hyperanalytical, and seems to benefit from some sort of technical background and experience with analytic philosophy. Personally, I find the prose riveting, and have found the Manual very engaging after my first few attempts to read it. However, I also know those who haven't been able to engage with the Manual, and found it either incomprehensible or aversive.
