...
One might imagine that Global Wayfinding is like dance, and how hard it would be to learn dance purely through text, without any practical experience. From this perspective, one might think of the Manual as an attempt at "instructions for how to teach yourself to dance", rather than "instructions on how to dance and what it is like to dance". See [this Twitter thread](https://twitter.com/meditationstuff/status/1565685229964218374?s=20&t=HEX59RP7csuo1BbrNkyy_Q) for more context on this.**\}**
